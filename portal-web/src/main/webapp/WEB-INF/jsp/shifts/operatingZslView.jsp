...
<!-- 	</div> -->
	...
	<div class="btn_group1" style="margin-left: 40px;">
		...
		<div class="btnStyle1 btn2 cur"><p><a href="${pageContext.request.contextPath}/shifts/operatingZslView">中水泵运行</a></p></div>
	...
	<table class="table user_table" style="margin-left: 40px;">
		<tbody>
			...
			<tr>
				<td  class="td-middle">稳压泵</td>
				<td  class="td-middle" colspan="2">状态</td>
				<td>√</td>
				<td>√</td>
				<td>√</td>
				<td>√</td>
