	...
	<table height="100"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
        ...
        <td width="198" height="39">
          <input name="deptnum" type="text" size="30" id="deptnum">
        </td>
      </tr>
      <tr>
        <td width="150" align="right">部门排序字段：</td>
        <td width="198" height="39">
          <input name="deptorder" type="text" size="30" id="deptorder">
        </td>
      </tr>
      <tr>
        <td width="80" align="right">上级部门：</td>
        <td height="35"><input name="parent"  id="parent" size="30"/>
      ...
      <tr>
        <td width="80" align="right">分管领导：</td>
         <td height="35"><input name="gm" type="text" id="gm" size="30">
         </td>
      </tr>
      <tr>
