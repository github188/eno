...
<body>
	<form action="doInsert" name="myForm" method="post">
		<table height="100" border="0" cellpadding="0" cellspacing="0"
			bgcolor="#FFFFFF">
			<tr>
				<td width="80" align="right">收信人：</td>
				<td height="35"><input name="userId" id="userId" value="${message.senderId}"
			...
			<tr>
				...
				<td width="198" height="39"><input name="title" type="text" value="RE:${message.title}"
					style="width: 250px" id="title">
				</td>
				 <td width="80" style="color: red">&nbsp*</td>
			</tr>
			<tr>
				...
				<td height="35"><textarea name="content" id="content"
						style="width: 250px; height: 200px"></textarea></td>
			</tr>
			<tr>
				<td align="center"></td>
				<td align="center">
...
$("#userId").combogrid({
	...
	function saveTo() {
        ...
        var g = $('#userId').combogrid('getValues'); 
		var dcUrl = "doInsertCg?title="+temp1+"&content="+temp2+"&userId="+temp3+"&Id="+g;
		if(g == "")
		{ 
		 document.getElementById("zt").style.display="none";//隐藏
		 document.getElementById("sxr").style.display="";//显示
