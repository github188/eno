...
<script type="text/javascript">var model = '新风机组';</script>
	...
	<div class="fault_content">
		...
		<div class="span5 chart_width">
			...
			<div>
				...
				<div class="chart_content">
					<div class="chart" style="height: 340px;" class="chart_style" id="status_sf_chart"></div>
				</div>
			</div>
		</div>
		...
		<div class="span5 chart_width">
			...
			<div>
				...
				<div class="chart_content">
					<div class="chart" style="height: 340px;" class="chart_style" id="frequency_sf_chart"></div>
				</div>
			</div>
		</div>
		...
		<div class="span5 chart_width">
			...
			<div>
				...
				<div class="chart_content">
					<div class="chart" style="height: 340px;" class="chart_style" id="t_sa_sp_chart"></div>
				</div>
			</div>
		</div>
	</div>
