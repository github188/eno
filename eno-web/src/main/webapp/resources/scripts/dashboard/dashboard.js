$(function() {
			...
			dashboard.buildTodayEnergyChart(); // 生成今日用能图表
...
var dashboard = {
	...
	// 生成今日用能图表
	buildTodayEnergyChart : function() {
	...
	buildCartonChart : function() {
		...
		$('#cartonchart').highcharts({
			...
			series : [{
				...
				color : '#FFBA00',
				data : [11, 68, 77, 85, 190, 198, 111, 123, 117, 111, 100, 92,
						87, 76, 61]
			}]
		});
