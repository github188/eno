...
function refreshDevicePool()
{
		...
		for (var i=0;i<tempDeviceList.length;i++)
    {
    	 ...
    	 else
    	 {
    	   ...
    	   {
    	 	   //alert("tempDeviceLis[i].name="+tempDeviceList[i].name+" tempDeviceList[i].classstructureid="+tempDeviceList[i].classstructureid+"  tempDeviceClassList[j].id="+tempDeviceClassList[j].id);
