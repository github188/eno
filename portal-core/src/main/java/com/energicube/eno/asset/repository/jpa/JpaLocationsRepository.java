 ...
 */
@Repository
public class JpaLocationsRepository {
     ...
     * 根据条件查找位置
     */
    public List<Locations> findLocationsWithDatatablesCriterias(DatatablesCriterias criterias) {

        StringBuilder queryBuilder = new StringBuilder("SELECT p FROM Locations p");
        ...
        TypedQuery<Locations> query = entityManager.createQuery(queryBuilder.toString(), Locations.class);
    ...
    /**
     * <p/>
     * Query used to return the number of filtered Locations.
     *
     * @param criterias The DataTables criterias used to filter the Locations.
     *                  (maxResult, filtering, paging, ...)
     * @return the number of filtered Locations.
     */
    ...
    public Long getTotalCount() {
        Query query = entityManager.createQuery("SELECT COUNT(p) FROM Locations p");
